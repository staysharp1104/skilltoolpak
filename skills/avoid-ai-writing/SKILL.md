...
# Avoid AI Writing â€” Audit & Rewrite
...
### Formatting
- **Em dashes (â€” and --)**: Replace with commas, periods, parentheses, or rewrite as two sentences. Target: zero. Hard max: one per 1,000 words. This applies to headings and section titles too, not just body prose. Catch both the Unicode em dash (â€”) and the double-hyphen substitute (--).
...
- **Emoji in headers**: Remove entirely. No `## ðŸš€ What This Means`. Exception: social posts may use one or two emoji sparingly â€” at the end of a line, never mid-sentence.
...
### Sentence structure
- **"It's not X â€” it's Y" / "This isn't about X, it's about Y"**: Rewrite as a direct positive statement. Max one per piece, and only if it serves the argument.
...
Words are organized into three tiers based on how reliably they signal AI-generated text. This tiered approach â€” adapted from [brandonwise/humanizer](https://github.com/brandonwise/humanizer)'s vocabulary research â€” reduces false positives on words that are fine in isolation but suspicious in clusters.

- **Tier 1 â€” Always flag.** These words appear 5â€“20x more often in AI text than human text. Replace on sight.
- **Tier 2 â€” Flag in clusters.** Individually fine, but two or more in the same paragraph is a strong AI signal. Flag when they appear together.
- **Tier 3 â€” Flag by density.** Common words that AI simply overuses. Only flag when they make up a noticeable fraction of the text (roughly 3%+ of total words).

#### Tier 1 â€” Always replace
...
| the future looks bright | (cut â€” say something specific or nothing) |
| only time will tell | (cut â€” say something specific or nothing) |
| nestled | is located, sits, is in |
| vibrant | (describe what makes it active, or cut) |
| thriving | growing, active (or cite a number) |
| despite challengesâ€¦ continues to thrive | (name the challenge and the response, or cut) |
...
| at its core | (cut â€” just state the thing) |
...
#### Tier 3 â€” Flag only at high density

These are normal words. Only flag them when the text is saturated with them â€” a sign that AI filled space with vague praise instead of specifics.
...
### Synonym cycling
- AI rotates synonyms to avoid repeating a word: "developersâ€¦ engineersâ€¦ practitionersâ€¦ builders" in the same paragraph. Human writers repeat the clearest word.
...
### Vague attributions
- "Experts believe," "Studies show," "Research suggests," "Industry leaders agree" â€” without naming the expert, study, or leader. Either cite a specific source or drop the attribution and state the claim directly.

### Filler phrases
- Strip mechanical padding that adds words without meaning:
  - "It is important to note that" â†’ (just state it)
  - "In terms of" â†’ (rewrite)
  - "The reality is that" â†’ (cut or just state the claim)
- Note: "In order to," "Due to the fact that," and "At the end of the day" are covered in the word/phrase table and transition sections above â€” don't duplicate rules.

### Generic conclusions
- "The future looks bright," "Only time will tell," "One thing is certain," "As we move forward" â€” these are filler disguised as conclusions. Cut them. If the piece needs a closing thought, make it specific to the argument.

### Chatbot artifacts
- "I hope this helps!", "Certainly!", "Absolutely!", "Great question!", "Feel free to reach out," "Let me know if you need anything else" â€” these are conversational tics from chat interfaces, not writing. Remove entirely.
- Also watch for: "In this article, we will exploreâ€¦" or "Let's dive in!" â€” these are AI-generated meta-narration. Cut or rewrite with a direct opening.

### "Let's" constructions
- "Let's explore," "Let's take a look," "Let's break this down," "Let's examine" â€” AI uses "let's" as a false-collaborative opener to ease into a topic. It's filler that delays the actual point. Just start with the point. "Let's dive in" is covered above under chatbot artifacts, but the pattern is broader than that â€” flag any "let's + verb" that's functioning as a transition rather than a genuine invitation to act.
...
### Sycophantic tone
- "Great question!", "Excellent point!", "You're absolutely right!", "That's a really insightful observation" â€” these are conversational rewards from chat interfaces, not writing. Remove entirely.
...
- "You're asking about," "The question of whether," "To answer your question," "That's a great question. The..." â€” AI restates the prompt before answering. In writing, this is pure filler. The reader knows what they asked. Just answer.
...
- "It's worth noting that," "Interestingly," "Surprisingly," "Importantly," "Significantly," "Notably," "Certainly," "Undoubtedly," "Without a doubt" â€” AI uses these to signal how the reader should feel about a fact instead of letting the fact speak for itself.
...
- Formulaic section headers: "Overview," "Key Points," "Summary," "Conclusion," "Introduction" â€” these are default AI scaffolding. Use headers that tell the reader something specific about what follows.
...
1. **Vary sentence length** â€” mix short with long. Fragments are fine.
2. **Be concrete** â€” replace vague claims with numbers, names, dates, or examples.
3. **Have a voice** â€” where appropriate, use first person, state preferences, show reactions.
4. **Cut the neutrality** â€” humans have opinions. If the piece is supposed to take a position, take it.
5. **Earn your emphasis** â€” don't tell the reader something is interesting. Make it interesting.
