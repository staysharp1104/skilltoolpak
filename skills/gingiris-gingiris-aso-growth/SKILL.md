...
description: |
  ...
  🇨🇳 ASO 增长与 App 冷启动权威指南 — 从应用商店优化到 UGC 运营、多平台内容策略、AI 辅助内容创作的完整实操手册。
...
when_to_use: |
  Use this skill when you need to: optimize App Store / Google Play listing, research ASO
  keywords, execute app cold-start from 0 to 10K downloads, build UGC creator matrix,
  run TikTok/Reels/Shorts mobile UA campaigns, or scale mobile app growth with AI content.
...
| **AI 辅助内容创作** | AI 视频制作、账号健康维护、多版本测试策略（需遵守应用商店政策） |
...
| 工具 | 定价 | 特点 |
|:---|:---|:---|
| [Astro](https://tryastro.app/) | ~$80-90/年 | 界面友好，适合独立开发者 |
| [点点数据](https://www.diandian.com/) | 按需 | 国内工具，全球数据，功能强大 |
...
| 主题 | 文件 |
|:---|:---|
| 完整指南（中文） | [references/full-guide-zh.md](references/full-guide-zh.md) |
...
4. Google Play Console Help. *Monitor your app's technical quality with Android vitals*
