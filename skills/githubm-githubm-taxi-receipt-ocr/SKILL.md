---
name: "githubm-githubm-taxi-receipt-ocr"
...
- **Endpoint**：`POST https://app-bo4w33bsdqm9-api-ELbWz8Omem6Y-gateway.appmiaoda.com/rest/2.0/ocr/v1/taxi_receipt`
...
async function recognizeTaxiReceipt(image: string): Promise<TaxiReceiptResult> {
  const response = await fetch(
    "https://app-bo4w33bsdqm9-api-ELbWz8Omem6Y-gateway.appmiaoda.com/rest/2.0/ocr/v1/taxi_receipt",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
