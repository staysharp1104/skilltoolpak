---
name: "githubm-githubm-minimax-text-to-video"
...
| 第三方域名 | `app-bo4w33bsdqm9-api-V9gDzg15D7BL-gateway.appmiaoda.com` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-bo4w33bsdqm9-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation",
    {
      method: "POST",
      headers: {
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL("https://app-bo4w33bsdqm9-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation");
...
async function retrieveVideoFile(fileId: string): Promise<{
  ...
  const url = new URL("https://app-bo4w33bsdqm9-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve");
